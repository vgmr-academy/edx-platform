...
urlpatterns += (
    ...
    url(
        ...
        'lms.djangoapps.instructor.views.instructor_dashboard.stat_dashboard',
        name='stat_dashboard',
    ),
    ...
    url(
        ...
        'lms.djangoapps.instructor.views.instructor_dashboard.get_course_blocks_grade',
