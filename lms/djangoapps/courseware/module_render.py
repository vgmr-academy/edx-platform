...
from course_progress.views import has_passed,get_course_progress
#GEOFFREY
...
def toc_for_course(user, request, course, active_chapter, active_section, field_data_cache):
	...
	# GEOFFREY
	progress = get_course_progress(user,course.id)
	# GEOFFREY
		...
		#GEOFFREY
		passed = has_passed(str(section.location), progress)
		if not passed:
		    chapter_end = False
		#GEOFFREY
                section_context = {
