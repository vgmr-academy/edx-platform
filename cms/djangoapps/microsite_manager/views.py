...
def admin_microsite(request, microsite_id=None):
    if request.method == 'GET':
        ...
        context['microsite_admin'] = get_microsite_admin_manager(microsite)
...
def update_microsite(request, microsite_id=None):
    if request.method == 'GET':
        ...
        current_logo_path = microsite_value.values()[current_logo_key]
        ...
        if microsite_logo or microsite_logo != '':
            ...
            microsite_logo_path = current_logo_path
            context['logo'] = False
        ...
        if microsite_logo or microsite_logo != '':
            ...
            logo_value_path = microsite_value.values()[current_logo_key]
        values_save = {
...
def launch_microsite(request, microsite_details):
        ...
        microsite = Microsite.objects.create(
            ...
            values = {
              ...
              "university":microsite_name,
              "platform_name":microsite_name,
              "logo":"/media/microsite/"+microsite_name+"/images/"+microsite_logo.name,
              "ENABLE_MKTG_SITE":False,
              "SITE_NAME":site_name,
              "course_org_filter":microsite_name,
              "course_about_show_social_links":False,
